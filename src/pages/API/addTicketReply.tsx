import "../../css/API/addTicketReply/style.scss";
import { useState } from "react";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
const tabsList = ["200", "400", "401"];
const AddTicketReply = () => {
  ...
  return (
    <div className="addticketreply">
      <div className="addticketreply-left">
        <div id="side-40" className="addticketreply-infor">
          <h2>Add Ticket Reply</h2>
      ...
      <div className="addticketreply-right">
        <div className="addticketreply-api">
          <div className="addticketreply-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/addticketreply</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/addticketreply</div>
              </div>
            )}
