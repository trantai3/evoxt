import "../../css/API/changeServerHostname/style.scss";
import { useState } from "react";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
const tabsList = ["200", "400", "401"];
const ChangeServerHostname = () => {
  ...
  return (
    <div className="changeserverhostname">
      <div className="changeserverhostname-left">
        <div id="side-26" className="changeserverhostname-infor">
          <h2>Change Server Hostname</h2>
          <p>
            Change the specified server hostname. A power cycle is required in
            order for the server hostname to be changed.
          </p>
      ...
      <div className="changeserverhostname-right">
        <div className="changeserverhostname-api">
          <div className="changeserverhostname-api-method">
...
export default ChangeServerHostname;
