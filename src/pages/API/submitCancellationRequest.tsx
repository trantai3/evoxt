import "../../css/API/submitCancellationRequest/style.scss";
...
const SubmitCancellationRequest = () => {
  ...
  return (
    <div className="submitcancellationrequest">
      <div className="submitcancellationrequest-left">
        <div id="side-36" className="submitcancellationrequest-infor">
          <h2>Submit Cancellation Request</h2>
          <p>Submit cancellation request for a service.</p>
      ...
      <div className="submitcancellationrequest-right">
        <div className="submitcancellationrequest-api">
          <div className="submitcancellationrequest-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/submitcancellation</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/submitcancellation
                </div>
              </div>
            )}
...
export default SubmitCancellationRequest;
