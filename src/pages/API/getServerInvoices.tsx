import "../../css/API/getServerInvoices/style.scss";
import { useState } from "react";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
const tabsList = ["200", "400", "401"];
const GetServerInvoices = () => {
  ...
  return (
    <div className="getserverinvoices">
      <div className="getserverinvoices-left">
        <div id="side-29" className="getserverinvoices-infor">
          <h2>Billing</h2>
          <p>Request library for billing related actions.</p>
          <br />
          <br />
          <h2 id="side-30">Get Server Invoices</h2>
          <p>Get all invoices that is related to the specified server.</p>
      ...
      <div className="getserverinvoices-right">
        <div className="getserverinvoices-api">
          <div className="getserverinvoices-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/getserverinvoices</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/getserverinvoices
                </div>
              </div>
            )}
...
export default GetServerInvoices;
