import "../../css/API/changeServerPassword/style.scss";
import { useState } from "react";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
const tabsList = ["200", "400", "401"];
const ChangeServerPassword = () => {
  ...
  return (
    <div className="changeserverpassword">
      <div className="changeserverpassword-left">
        <div id="side-25" className="changeserverpassword-infor">
          <h2>Change Server Password</h2>
          <p>
            Change the specified server password. The new server password
            submitted will recorded in Evoxt dashboard as well. If you do not
            want this to be recorded, change the password from the server side.
            A power cycle is required in order for the server password to be
            changed.
          </p>
      ...
      <div className="changeserverpassword-right">
        <div className="changeserverpassword-api">
          <div className="changeserverpassword-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/changeserverhostname</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/changeserverhostname
                </div>
              </div>
            )}
...
export default ChangeServerPassword;
