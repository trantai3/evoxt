import "../../css/API/openTicket/style.scss";
...
const OpenTicket = () => {
  ...
  return (
    <div className="openticket">
      <div className="openticket-left">
        <div id="side-38" className="openticket-infor">
          <h2>Support</h2>
          <p>Request library for support related actions.</p>
          <br />
          <h2 id="side-39">Open Ticket</h2>
      ...
      <div className="openticket-right">
        <div className="openticket-api">
          <div className="openticket-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/openticket</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/openticket</div>
              </div>
            )}
