import "../../css/API/addFirewallRule/style.scss";
...
const AddFirewallRule = () => {
  ...
  return (
    <div className="addfirewallrule">
      <div className="addfirewallrule-left">
        <div id="side-18" className="addfirewallrule-infor">
          <h2>Add firewall rules</h2>
          <p>
            Add firewall rules, firewall must be enabled in order to add
            firewall rules
          </p>
            ...
            <tbody>
              <tr>
                ...
                <tr>
                  <td className="td-left">
                    <span className="icon"></span>
                    <span className="td-name">protocol</span>
                  </td>
                  <td className="td-right">
                    <div className="td-right-string">string</div>
                    <div className="td-right-title">
                      Available protocol ( tcp, udp, icmp, gre, esp, ah )
                    </div>
                  </td>
                </tr>
                <tr>
      ...
      <div className="addfirewallrule-right">
        <div className="addfirewallrule-api">
          <div className="addfirewallrule-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/addfirewallrules</span>
              </div>
