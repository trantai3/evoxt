import "../../css/API/restoreServerBackup/style.scss";
...
const RestoreBackup = () => {
  ...
  return (
    <div className="restorebackup">
      <div className="restorebackup-left">
        <div id="side-22" className="restorebackup-infor">
      ...
      <div className="restorebackup-right">
        <div className="restorebackup-api">
          <div className="restorebackup-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/restoreserverbackup</span>
              </div>
