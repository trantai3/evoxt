import "../../css/API/getAccountCredits/style.scss";
import { useState } from "react";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
const tabsList = ["200", "400", "401"];
const GetAccountCredits = () => {
  ...
  return (
    <div className="getaccountcredits">
      <div className="getaccountcredits-left">
        <div id="side-35" className="getaccountcredits-infor">
          <h2>Get Account Credits</h2>
          <p>Get the credits available in your Evoxt account.</p>
      ...
      <div className="getaccountcredits-right">
        <div className="getaccountcredits-api">
          <div className="getaccountcredits-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">get</span>
                <span className="link">/getcredits</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/getcredits</div>
              </div>
            )}
