import "../../css/API/withdrawCancellationRequest/style.scss";
...
const WithdrawCancellationRequest = () => {
  ...
  return (
    <div className="withdrawcancellationrequest">
      <div className="withdrawcancellationrequest-left">
        <div id="side-37" className="withdrawcancellationrequest-infor">
          <h2>Withdraw Cancellation Request</h2>
          <p>
            Cancel your cancellation request.
            <br />
            Note : If you selected immediate cancellation, please try to cancel
            as soon as possible before the waiting period ends
          </p>
      ...
      <div className="withdrawcancellationrequest-right">
        <div className="withdrawcancellationrequest-api">
          <div className="withdrawcancellationrequest-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/withdrawcancellation</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/withdrawcancellation
                </div>
              </div>
            )}
...
export default WithdrawCancellationRequest;
