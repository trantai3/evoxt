import "../../css/API/upgradeServer/style.scss";
...
const UpgradeServer = () => {
  ...
  return (
    <div className="upgradeserver">
      <div className="upgradeserver-left">
        <div id="side-28" className="upgradeserver-infor">
          <h2>Upgrade Server</h2>
          <p>
            Upgrade a service, invoice id will be returned on successful
            request. You will need to pay for the invoice id returned to
            complete the upgrade request. For server upgrade, a power cycle is
            required for the new server specification to be applied.
          </p>
      ...
      <div className="upgradeserver-right">
        <div className="upgradeserver-api">
          <div className="upgradeserver-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/serverupgrade</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/serverupgrade</div>
              </div>
            )}
