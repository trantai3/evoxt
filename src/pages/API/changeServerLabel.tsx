import "../../css/API/changeServerLabel/style.scss";
import { useState } from "react";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
const tabsList = ["200", "400", "401"];
const ChangeServerLabel = () => {
  ...
  return (
    <div className="changeserverlabel">
      <div className="changeserverlabel-left">
        <div id="side-24" className="changeserverlabel-infor">
          <h2>Change Server Label</h2>
          <p>
            Get the server's label. This is shown on your Evoxt dashboard to
            label your virtual machines.
          </p>
      ...
      <div className="changeserverlabel-right">
        <div className="changeserverlabel-api">
          <div className="changeserverlabel-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/changeserverlabel</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/changeserverlabel
                </div>
              </div>
            )}
...
export default ChangeServerLabel;
