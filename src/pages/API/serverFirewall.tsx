import "../../css/API/serverFirewall/style.scss";
...
const ServerFirewall = () => {
  ...
  return (
    <div className="serverfirewall">
      <div className="serverfirewall-left">
        <div id="side-16" className="serverfirewall-infor">
          <h2>Get a Server Firewall information</h2>
          <p>Get specified server's Firewall information.</p>
      ...
      <div className="serverfirewall-right">
        <div className="serverfirewall-api">
          <div className="serverfirewall-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">get</span>
                <span className="link">/viewfirewallrules</span>
              </div>
