import "../../css/API/getInvoices/style.scss";
...
const GetInvoices = () => {
  ...
  return (
    <div className="getinvoices">
      <div className="getinvoices-left">
        <div id="side-31" className="getinvoices-infor">
          <h2>Get Invoices</h2>
          <p>
            Get all invoices in your Evoxt account. Add <strong>status</strong>{" "}
            parameter to filter our invoices with invoice status
          </p>
      ...
      <div className="getinvoices-right">
        <div className="getinvoices-api">
          <div className="getinvoices-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/getinvoices</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/getinvoices</div>
              </div>
            )}
