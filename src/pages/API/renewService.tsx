import "../../css/API/renewService/style.scss";
...
const RenewService = () => {
  ...
  return (
    <div className="renewservice">
      <div className="renewservice-left">
        <div id="side-34" className="renewservice-infor">
          <h2>Renew Service</h2>
          <p>
            Renew a service.
            <br />
            If a service is on a monthly plan, it will be renewed for a month.
            <br />
            If a service is on an annual plan, it will be renewed for a year.
            <br />
            This will be paid using Evoxt account credits automatically.
          </p>
      ...
      <div className="renewservice-right">
        <div className="renewservice-api">
          <div className="renewservice-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/renewservice</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/renewservice</div>
              </div>
            )}
