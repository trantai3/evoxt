import "../../css/API/serverStatus/style.scss";
...
const ServerStatus = () => {
  ...
  return (
    <div className="serverstatus">
      <div className="serverstatus-left">
        <div id="side-14" className="serverstatus-infor">
          <h2>Get a Server Status</h2>
          <p>
            Get specified server status. If the response status is 1, this means
            that the server is currently active and running. If the response 0
            means the server is currently powered off while when the response is
            2 means that the server is currently suspended.
            <br />
            <strong>cpu_percent </strong> is out of 100%
            <br />
            <strong>ram </strong>is in MB ( Megabytes binary )
            <br />
            <strong>disk </strong>is in GB( Gigabytes binary )
            <br />
            <strong>bandwidth </strong>is in GB ( Gigabytes binary )
          </p>
      ...
      <div className="serverstatus-right">
        <div className="serverstatus-api">
          <div className="serverstatus-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">get</span>
                <span className="link">/serverstatus</span>
              </div>
