import "../../css/API/serverPowerControl/style.scss";
import { useState } from "react";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
const tabsList = ["200", "400", "401"];
const ServerPowerControl = () => {
  ...
  return (
    <div className="serverpowercontrol">
      <div className="serverpowercontrol-left">
        <div id="side-23" className="serverpowercontrol-infor">
          <h2>Server Power Control</h2>
          <p>
            <strong>Power Off, Start,</strong> or <strong>Restart</strong> the
            server
          </p>
      ...
      <div className="serverpowercontrol-right">
        <div className="serverpowercontrol-api">
          <div className="serverpowercontrol-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/serverpowercontrol</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/serverpowercontrol
                </div>
              </div>
            )}
...
export default ServerPowerControl;
