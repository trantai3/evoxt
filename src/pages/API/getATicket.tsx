import "../../css/API/getATicket/style.scss";
...
const GetATicket = () => {
  ...
  return (
    <div className="getaticket">
      <div className="getaticket-left">
        <div id="side-41" className="getaticket-infor">
          <h2>Get a Ticket</h2>
          <p>Get a ticket details</p>
      ...
      <div className="getaticket-right">
        <div className="getaticket-api">
          <div className="getaticket-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">get</span>
                <span className="link">/getticket</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/getticket</div>
              </div>
            )}
