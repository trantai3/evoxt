import "../../css/API/payinvoice/style.scss";
...
const PayInvoice = () => {
  ...
  return (
    <div className="payinvoice">
      <div className="payinvoice-left">
        <div id="side-33" className="payinvoice-infor">
          <h2>Pay Invoice</h2>
          <p>Pay specified invoice with Evoxt Account Credits</p>
      ...
      <div className="payinvoice-right">
        <div className="payinvoice-api">
          <div className="payinvoice-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/payinvoice</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">https://api.evoxt.com/payinvoice</div>
              </div>
            )}
