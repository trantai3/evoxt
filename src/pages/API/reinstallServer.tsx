import "../../css/API/reinstallServer/style.scss";
...
const ReinstallServer = () => {
  ...
  return (
    <div className="reinstallserver">
      <div className="reinstallserver-left">
        <div id="side-27" className="reinstallserver-infor">
          <h2>Reinstall Server</h2>
          <p>
            Reinstall your server. This will usually takes around 5-10 minutes
            to be completed. Please try to wait for the reinstall to be
            completed before submitting another reinstall request.
          </p>
      ...
      <div className="reinstallserver-right">
        <div className="reinstallserver-api">
          <div className="reinstallserver-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/serverreinstall</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/serverreinstall
                </div>
              </div>
            )}
