import "../../css/API/enableFirewall/style.scss";
...
const EnableFirewall = () => {
  ...
  return (
    <div className="enablefirewall">
      <div className="enablefirewall-left">
        <div id="side-17" className="enablefirewall-infor">
          <h2>Enable firewall</h2>
          <p>
            Enable firewall. All ports and protocol will be blocked when enabled
          </p>
      ...
      <div className="enablefirewall-right">
        <div className="enablefirewall-api">
          <div className="enablefirewall-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/enableserverfirewall</span>
              </div>
