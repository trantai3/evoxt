import "../../css/API/getServerBackup/style.scss";
...
const ServerBackup = () => {
  ...
  return (
    <div className="serverbackup">
      <div className="serverbackup-left">
        <div id="side-21" className="serverbackup-infor">
          <h2>Get a Server Backup</h2>
          <p>Get specified server's Backup information.</p>
      ...
      <div className="serverbackup-right">
        <div className="serverbackup-api">
          <div className="serverbackup-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/getserverbackup</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/getserverbackup
                </div>
              </div>
            )}
