import "../../css/API/getTickets/style.scss";
...
const GetTickets = () => {
  ...
  return (
    <div className="gettickets">
      <div className="gettickets-left">
        <div id="side-42" className="gettickets-infor">
          <h2>Get Tickets</h2>
          <p>View all tickets in your Evoxt account</p>
      ...
      <div className="gettickets-right">
        <div className="gettickets-api">
          <div className="gettickets-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">get</span>
                <span className="link">/gettickets</span>
              </div>
