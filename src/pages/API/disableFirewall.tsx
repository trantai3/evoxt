import "../../css/API/disableFirewall/style.scss";
...
const DisableFirewall = () => {
  ...
  return (
    <div className="disablefirewall">
      <div className="disablefirewall-left">
        <div id="side-20" className="disablefirewall-infor">
          <h2>Disable firewall</h2>
          <p>
            Disable firewall. All ports and protocol will be unblocked when
            disabled
          </p>
      ...
      <div className="disablefirewall-right">
        <div className="disablefirewall-api">
          <div className="disablefirewall-api-method">
            <button onClick={() => toggleDropdownMethod("deployServer")}>
              <div className="link-method">
                <span className="post method">post</span>
                <span className="link">/disableserverfirewall</span>
              </div>
            ...
            {dropdownsMethod.deployServer === true && (
              <div className="sub-button">
                <div className="link">
                  https://api.evoxt.com/disableserverfirewall
                </div>
              </div>
            )}
